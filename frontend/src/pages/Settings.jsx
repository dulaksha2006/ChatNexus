    ...
    <Layout title="Settings">
      <div className="max-w-2xl space-y-6">
        ...
        <div className="card p-6">
          <div className="flex items-center gap-2.5 mb-5 pb-4 border-b border-[#1a1a1a]">
        ...
        {/* System info */}
        <div className="card p-6">
          <div className="flex items-center gap-2.5 mb-4 pb-4 border-b border-[#1a1a1a]">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={item.label} className="flex justify-between py-2 border-b border-[#1a1a1a] last:border-0 text-sm">
